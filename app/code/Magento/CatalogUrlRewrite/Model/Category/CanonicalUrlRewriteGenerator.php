...
class CanonicalUrlRewriteGenerator
{
    ...
    private function shouldSkipCustomUrlRewrite($storeId, Category $category, string $urlPath): bool
    {
        if ($category->dataHasChangedFor('url_key')
            ...
            || $category->dataHasChangedFor('parent_id')
        ) {
            return false;
        }
        ...
        $existingRewrite = $this->urlFinder->findOneByData(
            [
                ...
                UrlRewrite::ENTITY_TYPE => self::CUSTOM_ENTITY_TYPE,
                UrlRewrite::IS_AUTOGENERATED => 0,
            ]
        );

        return $existingRewrite
            && $existingRewrite->getUrlRewriteId() !== null
            && $existingRewrite->getRequestPath() === $urlPath
