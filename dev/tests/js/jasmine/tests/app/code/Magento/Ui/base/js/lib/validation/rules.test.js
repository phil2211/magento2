...
define([
    ...
    describe('Magento_Ui/js/lib/validation/rules', function () {
        ...
        describe('"validate-number-range" method', function () {
            ...
            it('should return true for negative decimal value within decimal range', function () {
                expect(rules['validate-number-range'].handler('-5', '-10.00-100.00')).toBe(true);
            });

            it('should return false for negative decimal value below decimal range', function () {
                expect(rules['validate-number-range'].handler('-15', '-10.00-100.00')).toBe(false);
            });
